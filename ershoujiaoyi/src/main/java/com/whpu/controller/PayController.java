...
import com.whpu.utils.AlipayConfig;
...
public class PayController  {
    ...
    //创建支付宝支付链接
    @RequestMapping("/creatPayForm")
    @ResponseBody
    public String creatPayForm(String checkway,String orderNumber,String payMoney)throws IOException{
...
//                    response.getWriter().close();
    ...
    public String alipayReturnNotice(HttpServletRequest request, HttpServletResponse response)throws IOException, ServletException{
