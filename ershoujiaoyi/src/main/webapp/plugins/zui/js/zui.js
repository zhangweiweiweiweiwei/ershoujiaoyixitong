...
(function($) {
    ...
    Menu.prototype.init = function() {
        ...
        //【modify by qiujy】处理打开的菜单的右边指示器
        this.$.find('.nav-parent.show').find('.nav-parent-fold-icon').addClass('icon-rotate-90');
    ...
    $(function() {
    	//【modify by qiujy】设置为只能打开一个菜单模式
        $('[data-toggle="menu"]').menu({auto:true});
    });
}(jQuery));
